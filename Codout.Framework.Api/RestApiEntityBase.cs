...
public abstract class RestApiEntityBase<TEntity, TDto, TId>(ICrudAppService<TEntity, TDto, TId> appService)
    : ControllerBase,
        IRestApi<TDto, TId>
    where TEntity : Entity<TId>
    where TDto : EntityDto<TId>
{
    public ICrudAppService<TEntity, TDto, TId> AppService { get; } = appService;
