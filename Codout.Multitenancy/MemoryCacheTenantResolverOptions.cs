...
/// <summary>
///     Configuration options for <see cref="MemoryCacheTenantResolver" />.
/// </summary>
public class MemoryCacheTenantResolverOptions
{
    ...
    /// <summary>
    ///     Gets or sets a setting that determines whether all cache entries for a <see cref="TenantContext" />
