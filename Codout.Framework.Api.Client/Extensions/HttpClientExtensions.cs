...
{
    public static async Task<TDtoOutput> PostAsync<TDtoOutput, TDtoInput>(this HttpClient client, string uriService,
        TDtoInput obj)
    {
    ...
    public static async Task<TDtoOutput> PutAsync<TDtoOutput, TDtoInput>(this HttpClient client, string uriService,
        TDtoInput obj)
    {
    ...
    private static async Task<Exception> GetExceptionAsync(this HttpResponseMessage httpResponseMessage,
