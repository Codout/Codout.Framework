...
{/// <summary>
 ...
 /// </summary>
    public abstract class EntityWithTypedId<TId> : BaseObject, IEntity<TId>
    {
        private TId _id;
        ...
        {
            return GetType().GetProperties().Where(p => p.CustomAttributes.Any(a => a.AttributeType == typeof(DomainSignatureAttribute)));
        }
