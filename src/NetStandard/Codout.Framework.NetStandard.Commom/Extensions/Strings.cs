...
namespace Codout.Framework.NetStandard.Commom.Extensions
{
    ...
    public static class Strings
    {
        ...
        public static string AsciiToUnicode(this int asciiCode)
        {
            ...
            Byte[] b = ascii.GetBytes(c.ToString(CultureInfo.InvariantCulture));
        ...
        public static string EntityToText(this string entityText)
        {
            ...
            return EntityTable.Aggregate(entityText, (current, key) => current.Replace(key.Value, AsciiToUnicode(key.Key)));
        }
        #endregion
        ...
        public static string RemoveCharactersSpecial(this string texto, bool aceitaEspaco = true, bool substituiAcentos = true)
        {
            string ret = texto;
