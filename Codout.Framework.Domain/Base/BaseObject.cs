...
public abstract class BaseObject
{
    ...
    public virtual IEnumerable<PropertyInfo> GetSignatureProperties()
    {
        ...
        if (_signaturePropertiesDictionary.TryGetValue(GetType(), out properties)) return properties;
    ...
    public virtual bool HasSameObjectSignatureAs(BaseObject compareTo)
    {
        ...
        if ((from property in propertyInfos
        ...
        return propertyInfos.Any() || base.Equals(compareTo);
    }
